...
<div class="fieldcontain ${hasErrors(bean: societeInstance, field: 'commentaire', 'error')} ">
    ...
    <richui:richTextEditor name="commentaire" value="${societeInstance?.commentaire}" />
</div>
...
<div class="fieldcontain ${hasErrors(bean: societeInstance, field: 'creation', 'error')} required">
    ...
    <richui:dateChooser name="creation" format="dd/MM/yyyy" value="${societeInstance?.creation}" />
</div>
...
<div class="fieldcontain ${hasErrors(bean: societeInstance, field: 'engagement', 'error')} required">
    ...
    <g:field type="number" name="engagement" required=""
             value="${fieldValue(bean: societeInstance, field: 'engagement')}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: societeInstance, field: 'resultatEntree', 'error')} required">
    ...
    <g:field type="number" name="resultatEntree" required=""
             value="${fieldValue(bean: societeInstance, field: 'resultatEntree')}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: societeInstance, field: 'resultatValo', 'error')} required">
    ...
    <g:field type="number" name="resultatValo" required=""
             value="${fieldValue(bean: societeInstance, field: 'resultatValo')}"/>
</div>
